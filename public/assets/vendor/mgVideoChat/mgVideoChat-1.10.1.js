...
;
(function( $, window, document, undefined ){
    $.fn.mgVideoChatRtcEvents = function(mgVideoChat, rtc, fileHelper){
        /**
        * Init RTC
        *
        */
...
(function( $, window, document, undefined ){
    ...
    var mgVideoChat = function( elem, options ){
        ...
        $.fn.mgVideoChatRtcEvents(mgVideoChat, rtc, fileHelper);
    ...
    mgVideoChat.prototype.createGroupStream = function(mediaOptions){
        var self = this;
        mediaOptions = mediaOptions ? mediaOptions :  this.getMediaOptions({audio:true, video:true});
