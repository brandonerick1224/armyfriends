if (typeof startappContainerId === 'undefined' || startappContainerId == null || startappContainerId == ''){
	startappContainerId = 'startappContainer';  /*default*/
}
...
function buildRequestString() {
	...
	var request = 'https://c2s.startappnetwork.com/c2s/1.3/htmlads?sdkType=10&sdkVersion=1.0.0&partner='+ publisherId
