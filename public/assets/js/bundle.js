...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/vedmant/Dropbox/WebProjects/_Freddy/FD-04_armyfriends.com/Repo/resources/assets/js/components/comments/comment-form.vue"
  if (!module.hot.data) {
...
exports.default = {
   ...
   methods: {
      ...
      update: function update() {
         ...
         this.$http.post(app.url + '/comments/update/' + this.comment.id, { content: this.editedContent }).then(function (response) {
      ...
      remove: function remove() {
         ...
         this.$http.get(app.url + '/comments/remove/' + this.comment.id).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/vedmant/Dropbox/WebProjects/_Freddy/FD-04_armyfriends.com/Repo/resources/assets/js/components/comments/comment.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
var _commentForm = require('./comment-form.vue');
...
exports.default = {
   ...
   components: {
      ...
      'comment-form': _commentForm2.default
   },
   ...
   methods: {
      ...
      addComments: function addComments(comments) {
      ...
      loadMore: function loadMore() {
         ...
         this.$http.get(app.url + '/comments/load/' + this.itemType + '/' + this.itemId + '/' + this.comments.items[0].id).then(function (response) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/vedmant/Dropbox/WebProjects/_Freddy/FD-04_armyfriends.com/Repo/resources/assets/js/components/comments/comments.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./comment-form.vue":28,"./comment.vue":29,"vue":27,"vue-hot-reload-api":2}],31:[function(require,module,exports){
'use strict';
...
var _vuePlugin = require('./vue-plugin');

var _vuePlugin2 = _interopRequireDefault(_vuePlugin);

var _comments = require('./components/comments/comments.vue');
...
_vue2.default.use(_vuePlugin2.default);

/**
 * Global components
 */
_vue2.default.component('comments', _comments2.default);

/**
 * Global Settings
 */
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = $('#meta-csrf-token').attr('content');

/**
 * Root Vue component
 */
var vueRoot = window.vueRoot = new _vue2.default({
  el: 'body'
});

},{"./components/comments/comments.vue":30,"./vue-plugin":32,"vue":27,"vue-resource":16}],32:[function(require,module,exports){
"use strict";
